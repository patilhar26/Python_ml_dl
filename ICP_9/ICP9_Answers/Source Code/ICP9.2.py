...
# Code for Question 2
# Description: A program to plot one of the images from the test data.
# Then doing inferencing to check the prediction of the model on that single image in the test data.
##-------------------------------------------------------------------------------------------------------------
import warnings
...
# Evaluating the result on test data anf get the loss and accuracy values
...
# Model prediction on the single image (450) from the test data.
